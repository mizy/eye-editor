...
(function () {
  ...
  THREE.TransformControls = function (camera, domElement) {
    ...
    this.update = function () {
      ...
      let coord = scope.object.position;
      worldPosition.set(coord.x, coord.y, coord.z);
    ...
    function onPointerMove(event) {
      ...
      if (_mode === "translate") {
        ...
        point.sub(scope.object.getWorldPosition(new THREE.Vector3()));
        point.multiply(parentScale);
